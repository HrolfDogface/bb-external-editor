  ...
  while (true){
    ...
    if(firstLoop){
      ...
      for (let i: number = 0; i < batches; i++){
        ...
        ns.exec("batch/W_worker2.js", exHost, weaken2Threads, targetHost, weaken2Delay + batchDelay * i, ns.pid);
      }
    }
    ...
    while (level == ns.getHackingLevel())
    {
      ...
      ns.exec("batch/W_worker2.js", exHost, weaken2Threads, targetHost, weaken2Delay, ns.pid);
