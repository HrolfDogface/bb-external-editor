export async function main(ns: NS) {
    ...
    ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: pre_batcher starting\n", "w");
    ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: target host name = " + targetHost + "\n", "a");
    ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: executing host name = " + exHost + "\n", "a");
    ...
    ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: prepWThreads = " + prepWThreads + "\n", "a");
    
    const prepGThreads: number = Math.floor((freeRam - prepRam - 2) * 0.79 / prepGRam);
    ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: prepGThreads = " + prepGThreads + "\n", "a");
    ...
    ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: done waiting for target prep\n", "a");
    ...
    while (true){
      ...
      ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: " + targetHost + " Hack time is "
      ...
      ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: cores = " + cores + "\n", "a"); 
      ...
      ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: hackThreads = " + hackThreads + "\n", "a");    
      ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: growthThreads = " + growthThreads + "\n", "a");
      ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: hackSecurity = " + hackSecurity + "\n", "a");
      ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: growSecurity = " + growSecurity + "\n", "a");
      ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: weakenAmount = " + weakenAmount + "\n", "a");
      ...
      ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: batchRam = " + batchRam + "\n", "a");
      ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: batches = " + batches + "\n", "a");
      ...
      if ((postBatchMoney == maxMoney) && (postBatchSecurity == minSecurity)){
        ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: Batch successfully completed\n", "w");
      } else {
        ns.write("batch/batchLog.txt", performance.now() + "[pre_batcher.ts]: Error. After batch server money = $"
